...
if __FILE__ == $0
	...
	elsif File.exist?( app.to_s + "/Frameworks/AppSealingFramework.framework/appsealing.lic" ) then
		get_accountID_hash_from_license_file( app.to_s + "/Frameworks/AppSealingFramework.framework/appsealing.lic" )		
	else
